...
uu:
	cc applyexp.c builtins/builtin_utils.c builtins/cd.c builtins/environment.c builtins/pwd.c builtins/export.c builtins/unset.c builtins/exit.c builtins/echo.c main.c parsing.c match_advance.c constructors.c execution.c finding_path.c ft_split.c minishell_utils.c handlecmd.c -lreadline libft.a
g:
